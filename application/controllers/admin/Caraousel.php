...
class Caraousel extends CI_Controller {
    ...
    public function simpan(){
        ...
        $this->session->set_flashdata('alert', '
        <div class="alert alert-success"><strong>Success!</strong> Berhasil Menambahkan Caraousel!.</div>
        ');
        redirect('admin/caraousel');
    }
    ...
    public function delete_data($id){
        ...
        if(file_exists($filename)){
                unlink(FCPATH.'/assets/upload/caraousel/'.$id);
            }
        $where = array(
            'foto' => $id
        );
        ...
        $this->session->set_flashdata('alert', '
        <div class="alert alert-success"><strong>Success!</strong> Berhasil Menghapus caraousel!.</div>
        ');
        redirect('admin/caraousel');
    }
